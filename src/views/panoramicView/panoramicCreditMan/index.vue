...
<!--            <div v-show="fadeShow">-->
        ...
        <div>
          ...
          <div class="el-col-24"
               style="display: flex;justify-content: space-around;height: 200px;margin-top: 20px;margin-bottom: 10px;">
            <div class="risk_Context_left">
        ...
        <div>
          ...
          <div class="el-col-24" style="margin-top: 5px">
            <el-table border stripe highlight-current-row :data="transData"
                      :header-cell-style="{background:'#BBBBBB',color:'#000000'}"
